...
namespace Plugins.Scripts.Dropbox
{
    public static class DropboxHelper
    {
        ...
        private const string AppKey = "lp6tkm8tuf7zgly";
        private const string AppSecret = "2y6a53hsulk0o0j";
        ...
        private const string AuthCode = "zOuyLYg8wmsAAAAAAAAHJUuXE0f2_oo8qZH74jE0GaA";
#endif

        // paste from GetRefreshToken() result, value of "refresh_token"
        private const string RefreshToken = "4QPChkRwwn4AAAAAAAAAAfw0hjnC7dWJFI0Wu40tEwUSkfEtQU5uzyQdUFwNHwSD";
